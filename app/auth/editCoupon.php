...
if (
    isset($_POST['product_id'])  && isset($_POST['code']) && isset($_POST['price_reduc'])
    ...
    $sql = 'UPDATE coupon SET product_id=:product_id, code=:code, price_reduc=:price_reduc, updated_at = NOW(), 
    started_at = :started_at, finished_at = :finished_at, finished_at = :finished_at, max_use = :max_use WHERE id=:id';
    $statement = $pdo->prepare($sql);
    if (
        $statement->execute([
    ...
    <div class="card-body">
      ...
      <form method="post">
        ...
        <div class="form-group">
          ...
          <input type="text" value="<?= $coupon->price_reduc; ?>" name="price_reduc" id="price_reduc"
            class="form-control">
        </div>
        ...
        <div class="form-group">
          ...
          <input type="datetime" value="<?= $coupon->started_at; ?>" name="started_at" id="started_at"
            class="form-control">
        </div>

        <div class="form-group">
          <label for="ref">fin</label>
          <input type="datetime" value="<?= $coupon->finished_at; ?>" name="finished_at" id="finished_at"
            class="form-control">
        </div>
