                    ...
                    <table class="table table-borderless table-shopping-cart">
                        ...
                        <tbody>
                            ...
                            if (empty($ids)) {
                                ...
                                $products = $DB->query('SELECT p.id as p_id, p.name,p.ref, p.price, p.description, 
                                        pimg.path
                                 FROM product AS p LEFT JOIN product_image AS pimg ON p.id = pimg.product_id 
                                 AND pimg.is_main = 1 WHERE p.id IN (' . implode(',', $ids) . ')');
                            }
            ...
            <aside class="col-md-3">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <dl class="dlist-align">
                            <dt>Total:</dt>
                            <dd class="text-right  h5"><strong> <?= number_format($totalPanierTVACoupon, 2, ',', ' ') ?>
                                    €</strong></dd>
                        </dl>
                        <hr>
